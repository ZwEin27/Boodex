...
- (void)layoutSubviews {
    ...
    for (AirUITabBarItem *item in [self items]) {
...
- (void)setItems:(NSArray *)items {
    for (AirUITabBarItem *item in items) {
...
- (void)setSelectedItem:(AirUITabBarItem *)selectedItem {
