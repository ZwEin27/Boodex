...
//  ZBook
//
//  Created by zwein on 5/25/14.
//  Copyright (c) 2014 lzhteng. All rights reserved.
//

#import "Air_SystemInfo.h"
...
+ (BOOL)isPhone35
{
	...
	{
		return [AirSystemInfo isScreenSize:CGSizeMake(320, 480)];
	}
#else	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
	return NO;
#endif	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
...
+ (BOOL)isPhoneRetina35
{
	...
	{
		return [AirSystemInfo isScreenSize:CGSizeMake(640, 960)];
	}
#else	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
	return NO;
#endif	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
...
+ (BOOL)isPhoneRetina4
{
	...
	{
		return [AirSystemInfo isScreenSize:CGSizeMake(640, 1136)];
	}
#else	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
	return NO;
#endif	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
...
{
#if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
	return [AirSystemInfo isScreenSize:CGSizeMake(768, 1024)];
#else	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
	return NO;
#endif	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
}
...
{
#if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
	return [AirSystemInfo isScreenSize:CGSizeMake(1536, 2048)];
#else	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
	return NO;
#endif	// #if (TARGET_OS_IPHONE || TARGET_IPHONE_SIMULATOR)
}
